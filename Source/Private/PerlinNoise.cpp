...
double PerlinNoise::octave_noise(double x, double y, double z, int octaves, double persistence)
{
  double total = 0;
  double frequency = 1;
  double amplitude = 1;
...
double PerlinNoise::grad(unsigned int hash, double x, double y, double z)
{
  int h = hash & 15;
